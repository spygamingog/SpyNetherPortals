...
public class SpyNetherPortals extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        getLogger().info("SpyNetherPortals v1.0.1 enabled. Linker and Chat/Tablist Sync active.");
    }
    ...
    private void checkAndLinkWorld(World world) {
        ...
        if (baseName != null) {
            ...
            if (overworld != null) {
                ...
                getLogger().info("Linked " + name + " to " + overworld.getName() + " for Chat/Tablist Sync.");
            }
        } else {
            ...
            if (nether != null) {
                ...
                getLogger().info("Linked " + name + " to " + nether.getName() + " for Chat/Tablist Sync.");
            }
            World end = SpyAPI.getWorld(name + "_the_end", false);
            if (end != null) {
                SpyAPI.linkWorlds(world, end);
                getLogger().info("Linked " + name + " to " + end.getName() + " for Chat/Tablist Sync.");
            }
        }
    }
